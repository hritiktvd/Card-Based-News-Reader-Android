...
import com.hritik.articlereader.endpoints.GetDataService_usa;
...
public class Discover_usa extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.usa); // for set actionbar title
        ...
        GetDataService_usa service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_usa.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_usa.this, array_List);
