...
import com.hritik.articlereader.endpoints.GetDataService_world;
...
public class Discover_world extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.world); // for set actionbar title
        ...
        GetDataService_world service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_world.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_world.this, array_List);
