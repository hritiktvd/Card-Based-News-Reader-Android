...
import com.hritik.articlereader.endpoints.GetDataService_aus;
...
public class Discover_aus extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.aus); // for set actionbar title
        ...
        GetDataService_aus service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_aus.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_aus.this, array_List);
