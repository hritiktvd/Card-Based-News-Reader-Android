...
import com.hritik.articlereader.endpoints.GetDataService_hindu;
...
public class Discover_hindu extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.thehindu); // for set actionbar title
        ...
        GetDataService_hindu service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_hindu.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_hindu.this, array_List);
