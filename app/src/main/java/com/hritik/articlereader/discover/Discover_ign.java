...
import com.hritik.articlereader.endpoints.GetDataService_ign;
...
public class Discover_ign extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.ign); // for set actionbar title
        ...
        GetDataService_ign service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_ign.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_ign.this, array_List);
