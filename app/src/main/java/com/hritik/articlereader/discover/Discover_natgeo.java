...
import com.hritik.articlereader.endpoints.GetDataService_natgeo;
...
public class Discover_natgeo extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.natgeo); // for set actionbar title
        ...
        GetDataService_natgeo service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_natgeo.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_natgeo.this, array_List);
