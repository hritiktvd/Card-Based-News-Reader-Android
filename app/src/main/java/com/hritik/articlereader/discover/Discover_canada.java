...
import com.hritik.articlereader.endpoints.GetDataService_canada;
...
public class Discover_canada extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.canada); // for set actionbar title
        ...
        GetDataService_canada service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_canada.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_canada.this, array_List);
