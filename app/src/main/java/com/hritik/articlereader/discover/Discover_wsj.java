...
import com.hritik.articlereader.endpoints.GetDataService_wsj;
...
public class Discover_wsj extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.wsj); // for set actionbar title
        ...
        GetDataService_wsj service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_wsj.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_wsj.this, array_List);
