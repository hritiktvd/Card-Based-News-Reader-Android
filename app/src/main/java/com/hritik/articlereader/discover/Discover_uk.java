...
import com.hritik.articlereader.endpoints.GetDataService_uk;
...
public class Discover_uk extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.uk); // for set actionbar title
        ...
        GetDataService_uk service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_uk.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_uk.this, array_List);
