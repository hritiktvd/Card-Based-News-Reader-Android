...
import com.hritik.articlereader.endpoints.GetDataService_bloomberg;
...
public class Discover_bloomberg extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.bloomberg); // for set actionbar title
        ...
        GetDataService_bloomberg service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_bloomberg.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_bloomberg.this, array_List);
