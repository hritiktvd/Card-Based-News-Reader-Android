...
import com.hritik.articlereader.endpoints.GetDataService_wired;
...
public class Discover_wired extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.wired); // for set actionbar title
        ...
        GetDataService_wired service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_wired.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_wired.this, array_List);
