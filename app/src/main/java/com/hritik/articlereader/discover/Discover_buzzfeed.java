...
import com.hritik.articlereader.endpoints.GetDataService_buzzfeed;
...
public class Discover_buzzfeed extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.buzzfeed); // for set actionbar title
        ...
        GetDataService_buzzfeed service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_buzzfeed.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_buzzfeed.this, array_List);
