...
import com.hritik.articlereader.endpoints.GetDataService_newzeal;
...
public class Discover_newzeal extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.nz); // for set actionbar title
        ...
        GetDataService_newzeal service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_newzeal.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_newzeal.this, array_List);
