...
import com.hritik.articlereader.endpoints.GetDataService_mtv;
...
public class Discover_mtv extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.mtv); // for set actionbar title
        ...
        GetDataService_mtv service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_mtv.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_mtv.this, array_List);
