...
import com.hritik.articlereader.endpoints.GetDataService_time;
...
public class Discover_time extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.time); // for set actionbar title
        ...
        GetDataService_time service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_time.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_time.this, array_List);
