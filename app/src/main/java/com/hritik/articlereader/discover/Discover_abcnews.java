...
import com.hritik.articlereader.endpoints.GetDataService_abcnews;
...
public class Discover_abcnews extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.abcnews); // for set actionbar title
        ...
        GetDataService_abcnews service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_abcnews.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_abcnews.this, array_List);
