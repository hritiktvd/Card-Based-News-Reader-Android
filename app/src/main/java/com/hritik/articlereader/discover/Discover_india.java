...
import com.hritik.articlereader.endpoints.GetDataService_india;
...
public class Discover_india extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.india); // for set actionbar title
        ...
        GetDataService_india service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_india.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_india.this, array_List);
