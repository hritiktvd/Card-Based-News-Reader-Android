...
import com.hritik.articlereader.endpoints.GetDataService_mashable;
...
public class Discover_mashable extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.mashable); // for set actionbar title
        ...
        GetDataService_mashable service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_mashable.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_mashable.this, array_List);
