...
import com.hritik.articlereader.endpoints.GetDataService_nytimes;
...
public class Discover_nytimes extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.nytimes); // for set actionbar title
        ...
        GetDataService_nytimes service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_nytimes.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_nytimes.this, array_List);
