...
import com.hritik.articlereader.endpoints.GetDataService_verge;
...
public class Discover_verge extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.verge); // for set actionbar title
        ...
        GetDataService_verge service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService_verge.class);
        ...
        articlecall.enqueue(new Callback<Entertainment>() {
            ...
            public void onResponse(Call<Entertainment> call, Response<Entertainment> response) {
                ...
                if (status.equals("ok")) {
                    ...
                    adapter = new Discover_adapter(Discover_verge.this, array_List);
