...
public class Discover_adapter extends RecyclerView.Adapter<Discover_adapter.VergeViewHolder> {
    ...
    public Discover_adapter(Context context, List<Article> articleList) {
    ...
    @NonNull
    @Override
    public VergeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.layout_news, parent, false);
        return new VergeViewHolder(view);
    }

    //binding the data to the view holder
    @Override
    public void onBindViewHolder(@NonNull VergeViewHolder holder, final int position) {
    ...
    class VergeViewHolder extends RecyclerView.ViewHolder {
